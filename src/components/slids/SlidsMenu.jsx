        ...
        <div className="carousel" ref={carrousel}>
            <div>
              <Link to="/calcaf">
                <div className="item">
                  <div className="image">
                    <img src={data[0].image === 0 ? "/imgCategory/calca-f.webp" : data[0].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/calcados">
                <div className="item">
                  <div className="image">
                    <img src={data[1].image === 0 ? "/imgCategory/tenis.webp" : data[1].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/vestido">
                <div className="item">
                  <div className="image">
                    <img src={data[2].image === 0 ? "/imgCategory/vestido.webp" : data[2].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/shortf">
                <div className="item">
                  <div className="image">
                    <img src={data[3].image === 0 ? "/imgCategory/shor-f.webp" : data[3].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/audiovideo">
                <div className="item">
                  <div className="image">
                    <img src={data[4].image === 0 ? "/imgCategory/audioevideo.webp" : data[4].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/ferramentas">
                <div className="item">
                  <div className="image">
                    <img src={data[5].image === 0 ? "/imgCategory/ferramentas.webp" : data[5].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/eletronico">
                <div className="item">
                  <div className="image">
                    <img src={data[6].image === 0 ? "/imgCategory/eletronico.webp" : data[6].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/estetica">
                <div className="item">
                  <div className="image">
                    <img src={data[7].image === 0 ? "/imgCategory/estetica.webp" : data[7].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/bone">
                <div className="item">
                  <div className="image">
                    <img src={data[8].image === 0 ? "/imgCategory/bone.webp" : data[8].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/shortm">
                <div className="item">
                  <div className="image">
                    <img src={data[9].image === 0 ? "/imgCategory/short-m.webp" : data[9].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/calcam">
                <div className="item">
                  <div className="image">
                    <img src={data[10].image === 0 ? "/imgCategory/calca-m.webp" : data[10].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/informatica">
                <div className="item">
                  <div className="image">
                    <img src={data[11].image === 0 ? "/imgCategory/info.webp" : data[11].image} alt="img" />
                  </div>
                </div>
                <div className="info">
          ...
          <div>
              <Link to="/smartphone">
                <div className="item">
                  <div className="image">
                    <img src={data[12].image === 0 ? "/imgCategory/Smartphone.webp" : data[12].image} alt="img" />
                  </div>
                </div>
                <div className="info">
