  ...
  return (
    <>
      <ContainerPolitica>
        ...
        <p>
          A sua privacidade é importante para nós. É política do OnShops
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site OnShops, e outros sites que possuímos e
          operamos.
        </p>
        <p>
        ...
        <p>
          ...
          informação que o OnShops oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <span>
        ...
        <span>
          ...
          (softwares) do OnShops, de seus fornecedores ou terceiros, para
        ...
        <p>Esta política é efetiva a partir de 24 November 2023 01:03</p>
      </ContainerPolitica>
    </>
  );
}
