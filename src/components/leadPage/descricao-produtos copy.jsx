        ...
        <section>
          {dataProductFilter == "" ? (
            ...
            dataProductFilter.map((res) => {
              ...
              function over5() {
                document.getElementById("logo").src = `${image[5] || image[3]}`;
              }

              function over6() {
                document.getElementById("logo").src = `${image[6] || image[2]}`;
              }
                    ...
                    <div className="">
                      <div className="">
                        ...
                        <p>
                          ...
                          >
                            {dataCores ? dataCores : "Escolha uma cor"}
                          </span>
                        </p>
                        <div>
                          <div
