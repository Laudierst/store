...
//console.log(lastPart);
  ...
  const descProduct = useSelector(productsSlice => productsSlice.cart.idDescription)
  //const comentarios = useSelector(comnetarioSlice => comnetarioSlice.comentarios.items)

  const descFilterProduct = descProduct.filter(productData => (productData.id === lastPart))

  //const fiterDataProduct = [descFilterProduct]

  console.log(descFilterProduct, "loading...")
  
  const dataProductFilter = product.filter(productData => (productData.id === lastPart))
  ...
  const FilterColor4 = Todes.filter(e => e == "ROSA" || e == "Rosa" || e == "rosa" || e == "pinck" || e == "Pink" || e == "PINK")
  ...
  const FilterColor23 = Todes.filter(e => e == "Jeans claro" || e == "Jeans Claro" || e == "jeans claro" || e == "JEANS CLARO" || e == "Jenas Escuro" || e == "Azul Escuro" || e == "Azul escuro" || e == "Azul claro" || e == "azul claro" || e == "Azul Claro")
  ...
  const FilterColor38 = Todes.filter(e => e == "Preto com cinza" || e == "preto com cinza" || e == "Preto com Cinza" || e == "PRETO COM CINZA")
  ...
  const FilterColor50 = Todes.filter(e =>  e == "Caramelo" || e == "caramelo" || e == "CARAMELO")
  const FilterColor51 = Todes.filter(e =>  e == "Cinza com mescla" || e == "cinza com mescla" || e == "Cinza com Mescla" || e == "CINZA COM MESCLA")
  const FilterColor52 = Todes.filter(e =>  e == "Preto com mescla" || e == "preto com mescla" || e == "Preto com Mescla" || e == "PRETO COM MESCLA")
  const FilterColor53 = Todes.filter(e => e == "lilais" || e == "Lilais" || e == "LILAIS")
            ...
            return (
              <>
                ...
                <ProductDescPrimary>
                  <ProduVideoPlay2>
                    {image[5] == "" ? "" :
                      <Video style={{width: "320%", height: 180, margin: "auto", display: "flex"}}>
                  ...
                  {imgCart.map(imgCard => (
                    ...
                    <div role="group" aria-label="Basic example" className='efctButton'>
                      ...
                      {FilterColor2[0] ? <button type="button" style={{background: "#4c4b51", border: "none", color: "white", padding: "15px"}} onClick={() => setDatacores(FilterColor2[0])}></button> : ""}
                      ...
                      {FilterColor10[0] ? <button type="button" style={{background: "#e6c407", border: "none", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor10[0])}></button> : ""}
                      {FilterColor11[0] ? <button type="button" style={{background: "#e0f809", borderColor: "green", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor11[0])}></button> : ""}
                      ...
                      {FilterColor19[0] ? <button type="button" style={{background: "#f3d00b", borderColor: "green", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor19[0])}></button> : ""}
                      ...
                      {FilterColor42[0] ? <button type="button" style={{background: "#1b7dd4", borderColor: "green", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor42[0])}></button> : ""}
                      ...
                      {FilterColor50[0] ? <button type="button" style={{background: "#dc6c26", borderColor: "green", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor50[0])}></button> : ""}
                      {FilterColor51[0] ? <button type="button" style={{background: "linear-gradient(90deg, #45444a, ##81879F", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor51[0])}></button> : ""}
                      {FilterColor52[0] ? <button type="button" style={{background: "linear-gradient(90deg, black, ##81879F", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor52[0])}></button> : ""}
                      {FilterColor53[0] ? <button type="button" style={{background: "#b4a1cb", color: "red", padding: "15px"}} onClick={() => setDatacores(FilterColor53[0])}></button> : ""}
                      { }
                    </div>
                    <br />
                    </div>
