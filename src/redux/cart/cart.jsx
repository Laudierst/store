...
const initialState = {
    ...
    urlNovaGuia: localStorage.getItem("urlNovaGuia") ? JSON.parse(localStorage.getItem("urlNovaGuia")) : [],
...
const cartSlice = createSlice({
    ...
    reducers: {
        ...
        urlNova(state, action) {
            ...
            const itemsIndex = state.urlNovaGuia.findIndex((item) => item.id === action.payload.id)
...
export const { addCart, removeFromCart, decrementCart, cauculateTotal, clearCart, addCor, addTm, urlNova, removeCores, addDecription } = cartSlice.actions;
